...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            $pst = $con->prepare('SELECT * FROM retraits_mensuels WHERE id_rm=:id');
            $pst->execute([
                "id" => intval($_GET['id'])
            ]);
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Modification Retrait Mensualite</h3>
                    ...
                    <div class="row row-card-no-pd d-flex justify-content-center">
                        ...
                        <div class="col-md-12">
                            <div class="card centered">
                                ...
                                <form class="row g-3"
                                    action="./traitement/udpate_retrait_menusalite.php?id=<?= $_GET['id'] ?>"
                                    method="post">
                                    <div class="col-md-12">
