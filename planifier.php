      ...
      <div class="container">
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
              <h3 class="fw-bold mb-3">Planification Cotisation</h3>
          ...
          <div class="row row-card-no-pd d-flex justify-content-center">
            ...
            <div class="col-md-12">
              <div class="card centered">
                ...
                <form class="row g-3" action="./traitement/planifierautrecotisation.php" method="post">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control" id="datepayement" name="datep" value="<?= date("Y-m-d") ?>"
                      disabled="true">
