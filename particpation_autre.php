                                ...
                                <form class="row g-3" action="./traitement/add_Autre.php" method="post">
                                    ...
                                    <div class="col-md-12 select-box1">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-3 select-option1"
                                                placeholder="Sélectionner une cotisation" id="soValue1" readonly
                                                name="idc" style="cursor: pointer;">

                                        </div>

                                        <div class="col-md-12 content1" style="position:relative">
                                            <input type="hidden" id="idcot" class="form-control mb-3" name="idcot">
                                            ...
                                            <ul class="options1">
                                                ...
                                                $pst = $con->prepare('SELECT * FROM autres_cotisations ORDER BY id_ac DESC');
                                                $pst->execute();
                                                $count = $pst->rowCount();
                                                $res = $pst->fetchAll(PDO::FETCH_ASSOC);
                                                foreach ($res as $rs) {
                                    ...
                                    <?php } else { ?>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary" disabled="true">Ajouter maintenant</button>
                                        </div>
                                    <?php } ?>
                                </form>
                            </div>
