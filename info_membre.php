            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php if ($rs) {
  $range = 10; // Nombre maximum de pages visibles dans la pagination
  $start = max(1, $current - floor($range / 2));
  $end = min($pages, $start + $range - 1);

  // Ajustement si la fin est trop proche du début
...
?>
                  <nav aria-label="Page navigation" class="mt-4">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item">
                        <a class="page-link"
                          href="?page=<?= $pages ?>&search=<?= urlencode($search) ?>"><?= $pages ?></a>
                      </li>
                      <?php endif; ?>
